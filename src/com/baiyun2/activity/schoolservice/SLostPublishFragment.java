...
public class SLostPublishFragment  extends BaseFragment{
	...
	private void submitContent(){
		...
		String userName = UserInfoSP.getSingleInstance(getActivity()).getXh();
	...
	private void getMyLostPublish(final boolean isRefresh){
		...
		String name = UserInfoSP.getSingleInstance(getActivity()).getXh();
	...
	private class MyListAdapter extends CommonAdapter<LostPar>{
		...
		@Override
		public void convert(ViewHolder helper, final LostPar item) {
