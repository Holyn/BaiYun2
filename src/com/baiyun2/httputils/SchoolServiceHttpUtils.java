...
import com.baiyun2.httputils.SchoolLifeHttpUtils.onGetAdListener;
...
public class SchoolServiceHttpUtils extends HttpUtils {
	...
	public interface onGetAdListener{//校园服务--首页滚动图片
	...
	public void getAd(final onGetAdListener oGetAdListener){
		send(HttpMethod.GET, HttpURL.S_AD, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				oGetAdListener.onGetAd(picPars);
			}

			@Override
			public void onFailure(HttpException error, String msg) {
				oGetAdListener.onGetAd(null);
				Toast.makeText(context, "数据请求失败", Toast.LENGTH_SHORT).show();
			}
