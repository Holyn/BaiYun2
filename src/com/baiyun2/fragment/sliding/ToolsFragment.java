		...
		rb_1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				if (isChecked) {
					...
					tv_1.setTextColor(getActivity().getResources().getColor(R.color.white));
					tv_item_title.setText("班车表");
					
					switchFragment(0);
				}else {
					tv_1.setTextColor(getActivity().getResources().getColor(R.color.gray_tab_text));
				}
		...
		rb_2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				if (isChecked) {
					...
					tv_2.setTextColor(getActivity().getResources().getColor(R.color.white));
					tv_item_title.setText("地铁线路图");
					
					switchFragment(1);
				}else {
					tv_2.setTextColor(getActivity().getResources().getColor(R.color.gray_tab_text));
				}
			}
		...
		rb_3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				if (isChecked) {
					...
					tv_3.setTextColor(getActivity().getResources().getColor(R.color.white));
					tv_item_title.setText("扫描找书");
					
					switchFragment(2);
				}else {
					tv_3.setTextColor(getActivity().getResources().getColor(R.color.gray_tab_text));
				}
			}
